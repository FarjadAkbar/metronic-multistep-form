...
15. Access the /multistep route to view the multistep form. Fill out the form and submit to see the results
16. multistep file code is resources\views\pages\multistep.blade.php file.
